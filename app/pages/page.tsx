                    ...
                    <div className="py-5">
                        ...
                        <ul className="m-5">
                            {project.key_features.map((feature, index) => (
                                <li key={index} className="py-2 text-sm">● {feature}</li>
                            ))}
                        </ul>
                    </div>
                    <div className="font-bold text-primaryColor text-lg">Technologies Used:</div>
                    <div className="flex flex-row flex-wrap justify-center md:justify-start items-center text-lightTheme py-5">
                        {project.technologies.map((technology, index) => (
                            <div key={index} className="bg-grayColor px-4 py-2 mr-2 mt-2 shadow-lg rounded text-xs">
                                {technology}
                            </div>
                        ))}
                    </div>
